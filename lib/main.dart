    ...
    return MultiProvider(
        providers: [
          ...
          ChangeNotifierProxyProvider<AuthProivder, Products>(
            ...
            update: (_, auth, previousSnapshot) => Products(auth.token!,
          ...
          ChangeNotifierProxyProvider<AuthProivder, Orders>(
            ...
            update: (_, auth, previousSnapshot) => Orders(auth.token!,
        ...
        child: Consumer<AuthProivder>(
          builder: (context, value, _) {
            return MaterialApp(
              ...
              home:
                  !value.isAuth ? AuthScreen() : const ProductsOverviewScreen(),
